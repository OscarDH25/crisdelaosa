            ...
            <ul class="features">
                ...
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> Sin ningún compromiso de permanencia
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> Totalmente online
                </li>
            </ul>
            @if (Cookie::get('usuario_nombre') && Cookie::get('usuario_correo'))
                <button class="form-btn">
                    <a href="{{ route('subscribe', ['plan_id' => 'price_1PKMvcLBlcncf3EWiklxhh5j']) }}" class="form-btn">Seleccionar Plan</a>
                </button>
            @else
            ...
            <ul class="features">
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> 5 sesiones de 45 minutos
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> En un periodo máximo de 3 meses
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> Seguimiento semanal, totalmente online
                </li>
            </ul>
            @if (Cookie::get('usuario_nombre') && Cookie::get('usuario_correo'))
                <button class="form-btn">
            ...
            <ul class="features">
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> 10 sesiones de 1 hora cada una
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
                        <path d="M9 16.2l-3.5-3.5-1.4 1.4 5.9 5.9L21 7.9l-1.4-1.4z" />
                    </svg> En un periodo máximo de 7 meses
                </li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="check-icon">
                        <path fill="none" d="M0 0h24v24H0z" />
